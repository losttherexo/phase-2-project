    ...
    return (
        <div className='aboutPage'>
            ...
            <div className='aboutContainer'>
                ...
                <div className='aboutCard'>
                    <h2>Robert</h2>
                    <img className='aboutImage' src="https://scontent-lga3-2.xx.fbcdn.net/v/t39.30808-6/271990853_10216879986826572_7605611517030036169_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=6Kylu9CUKXwAX8At6co&_nc_ht=scontent-lga3-2.xx&oh=00_AfB6DduihupmkdvLFhu2CRkHfD-ixQs7V3el-2varabEgQ&oe=640D8B14"/>
